...
class GameController < ApplicationController
  ...
  def desc
    resp = {label: {en: "Author Language game"}, description: {en: "populate the Languages written and spoken (P1412) property by guessing from notable works or citizenship.  Report problems to User:Ijon"}, icon: 'https://upload.wikimedia.org/wikipedia/commons/b/bb/P1412_logo.jpg'}
